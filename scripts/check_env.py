...
def main() -> int:
    ...
    if shutil.which("ffmpeg"):
        ...
        checks.append(("libass/subtitles", " subtitles " in filters or " ass " in filters, "available" if " subtitles " in filters or " ass " in filters else "missing; annotations can use PIL/ASS fallback"))
    if args.edit_dir:
